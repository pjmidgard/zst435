...
numbers = []
namez = input("ul,c,c2c3 or for compress cl for extract for compress zst cld,u,u2,u3 fo extract zst cldd ul4 ; cl4, ul5; cl5 and cld3; cldd3? ")
	            ...
	            for byte in sda:
	                ...
	                if a == block:
	                    ...
	                    if lenfg>0:
	                        ...
	                        if notexist>virationc-1 or notexist<0:
	                            raise SystemExit
	                        ...
	                        for byte in sda:
	                            ...
	                            while eo<sdad:
	                                ...
	                                while sw<long:
	                                    ...
	                                    numbertc3=numbertc%virationc
	                                    numbertc1=numbertc//virationc
